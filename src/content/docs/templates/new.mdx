...
- [`new single-layer`](../new-single-layer) - Creates a new single layer project
- [`new microservices`](../new-microservices) - Creates a new microservices solution
...
All http templates use Fast Endpoints which is a cool library for building minimal APIs but fear not as you can just use controllers or regular minimal APIs as you'd use in your own project.
