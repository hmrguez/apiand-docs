        ...
        <section className="relative min-h-screen flex items-center justify-center pt-24 pb-20 px-6">
            ...
            <div className="max-w-5xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
                    <AnimatedText animation="fade-in-up" delay={400} as="div">
                        <Link to="/apiand-docs/docs/intro">
                    ...
                    <AnimatedText animation="fade-in-up" delay={500} as="div">
                        <a href="https://github.com/hmrguez/apiand" target="_blank">
