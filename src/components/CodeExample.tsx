...
public class UserService : IUserService
{
    ...
    return (
        <section className="py-24 px-6 bg-gradient-to-b from-gray-50 to-white" id="code">
                    ...
                    <div className="w-full lg:w-1/2 space-y-6">
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                >
                                    <div
                                        className="w-6 h-6 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center mr-3 flex-shrink-0">
